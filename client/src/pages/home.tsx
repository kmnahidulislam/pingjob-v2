            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-3xl font-bold mb-2">
                  {Array.isArray(recentJobs) ? recentJobs.length : '14,688'}
                </div>
                <div className="text-blue-100">Active Jobs</div>
              </div>
              <div>
                <div className="text-3xl font-bold mb-2">
                  {Array.isArray(companies) ? companies.length : '76,823'}
                </div>
              ...
              <div>
                <div className="text-3xl font-bold mb-2">2,203</div>
                <div className="text-blue-100">Posted Today</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-6 gap-6">
              <div className="text-center">
                ...
                <div className="text-green-600 font-medium text-sm">100% Client-Only Jobs</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-blue-600 font-medium text-sm">10X Recruiter Engagement</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-purple-600 font-medium text-sm">One Clear Goal</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-gray-600 font-medium text-sm">AI-Powered Matching</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-orange-600 font-medium text-sm">Real-Time Analytics</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-red-600 font-medium text-sm">Resume Score™</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-6">
                {Array.isArray(recentJobs) && recentJobs.slice(0, 6).map((job: any) => (
